...
public class Http2Client implements IHttpClient {
    ...
    public void handleResponse(ResponseWrapper wrapper, Request request) throws IOException {
        List<Protocol> supportProtocol = new ArrayList<Protocol>();
        supportProtocol.add(Protocol.HTTP_2);
        supportProtocol.add(Protocol.HTTP_1_1);
        ...
        if (response.isSuccessful()) {
            ...
            LOG.debug("OkHttp-Selected-Protocol:" + response.header("OkHttp-Selected-Protocol"));
            System.out.println("OkHttp-Selected-Protocol:" + response.header("OkHttp-Selected-Protocol"));
            System.out.println("OkHttp-Selected-Protocol:" + response.protocol().toString());
